...
from ceo.member_view import member_dashboard
from ceo.finance import FinanceListView, finance_transfer, finance_create, finance_update, finance_delete, reset_donation_balance
from  ceo.sales_crm_view import  CustomerCreateAPIView
...
urlpatterns = [
    ...
    path('finance/<int:pk>/update/', finance_update, name='finance_update'),
    path('finance/<int:pk>/delete/', finance_delete, name='finance_delete'),
    path('finance/transfer/', finance_transfer, name='finance_transfer'),
    path('finance/reset_donation/', reset_donation_balance, name='reset_donation_balance'),
    path('member-dashboard/', member_dashboard, name='member_dashboard'),
    path('api/customers/create/', CustomerCreateAPIView.as_view(), name='customer-create'),
]
